...
def generate_sql_query(prompt, entities_actions):
    ...
    system_message = (
        ...
        "- Use exact table and column names.\n"
            "-if required, Use aggregation functions (COUNT, SUM, AVG, etc.) with meaningful aliases (e.g., 'AS TotalSum', 'AS AverageValue').\n"
    ...
    "- Concatenate FirstName and LastName if it's in the query string."
    "- Schema Context:\n"
    f"{entities_actions}\n"
